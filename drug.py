...
df.to_csv(r'C:\Users\Dell\OneDrive\Desktop\Data Analytics\Drug\cleaned_drug_data.csv', index=False)
...
df.to_csv(r'C:\Users\Dell\OneDrive\Desktop\Data Analytics\Drug\processed_drug_data.csv', index=False)
